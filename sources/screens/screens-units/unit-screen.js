...
export default class Unit extends React.Component {
	...
	Eingabe = (x) => {
		...
		switch (x) {
			...
			case ("c"): {
				this.eingabemultiplyer = 1 / 299792458;
			}
				break;
			case ("m/s"): {
				this.eingabemultiplyer = 1;
			}
				break;
			case ("km/h"): {
				this.eingabemultiplyer = 3.6;
			}
				break;
			case ("kn"): {
				this.eingabemultiplyer = 1.94384;
			}
				break;
			case ("mph"): {
				this.eingabemultiplyer = 2.23694;
			}
				break;

			case ("Lj"): {
				this.eingabemultiplyer = 1 / 9460730472580800;
			}
				break;
			case ("Ae"): {
				this.eingabemultiplyer = 1 / 149597870700;
			}
				break;
			case ("mi"): {
				this.eingabemultiplyer = 0.000621371;
			}
				break;
			case ("inch"): {
				this.eingabemultiplyer = 39.3701;
			}
				break;
			case ("km"): {
				this.eingabemultiplyer = 0.001;
			}
				break;
			case ("m"): {
				this.eingabemultiplyer = 1;
				...
				break;
			case ("dm"): {
				this.eingabemultiplyer = 10;
			}
				break;
			case ("cm"): {
				this.eingabemultiplyer = 100;
			}
				break;
			case ("mm"): {
				this.eingabemultiplyer = 1000;
			}
				break;
			...
			case ("t"): {
				...
				break;
			case ("ztr"): {
				this.eingabemultiplyer = 0.02;
			}
				break;
			case ("oz"): {
				this.eingabemultiplyer = 35.274;
			}
				break;
			case ("lb"): {
				this.eingabemultiplyer = 2.20462;
			}
				break;
			case ("EM"): {
				this.eingabemultiplyer = 1 / (5.9722 * Math.pow(10, 24));
			}
				break;
			case ("SM"): {
				this.eingabemultiplyer = 1 / (1.9891 * Math.pow(10, 30));
			}
				break;
			case ("AM"): {
				this.eingabemultiplyer = 6.02214 * Math.pow(10, 26);
			}
				break;
		}
		this.Berechnung();
	...
	Umrechner = (x) => {
		...
		switch (x) {
			...
			case ("m/s"): {
				this.umrechnermultiplyer = 1;
			}
				break;
			case ("c"): {
				this.umrechnermultiplyer = 1 / 299792458;
			}
				break;
			case ("km/h"): {
				this.umrechnermultiplyer = 3.6;
			}
				break;
			case ("kn"): {
				this.umrechnermultiplyer = 1.94384;
			}
				break;
			case ("mph"): {
				this.umrechnermultiplyer = 2.23694;
			}
				break;

			case ("Lj"): {
				this.umrechnermultiplyer = 1 / 9460730472580800;
			}
				break;
			case ("Ae"): {
				this.umrechnermultiplyer = 1 / 149597870700;
			}
				break;
			case ("mi"): {
				this.umrechnermultiplyer = 0.000621371;
			}
				break;
			case ("inch"): {
				this.umrechnermultiplyer = 39.3701;
			}
				break;
			case ("km"): {
				this.umrechnermultiplyer = 0.001;
			}
				break;
			case ("m"): {
				this.umrechnermultiplyer = 1;
				...
				break;
			case ("dm"): {
				this.umrechnermultiplyer = 10;
			}
				break;
			case ("cm"): {
				this.umrechnermultiplyer = 100;
			}
				break;
			case ("mm"): {
				this.umrechnermultiplyer = 1000;
			}
				break;
			...
			case ("t"): {
				...
				break;
			case ("ztr"): {
				this.umrechnermultiplyer = 0.02;
			}
				break;
			case ("oz"): {
				this.umrechnermultiplyer = 35.274;
			}
				break;
			case ("lb"): {
				this.umrechnermultiplyer = 2.20462;
			}
				break;
			case ("EM"): {
				this.umrechnermultiplyer = 1 / (5.9722 * Math.pow(10, 24));
			}
				break;
			case ("SM"): {
				this.umrechnermultiplyer = 1 / (1.9891 * Math.pow(10, 30));
			}
				break;
			case ("AM"): {
				this.umrechnermultiplyer = 6.02214 * Math.pow(10, 26);
			}
				break;
		}
		this.Berechnung();
			...
			<View style={styles.container}>
				...
				<ScrollView>
					<View style={[styles.inputContainer, styles.zinsContainer]}>
						...
						<Picker selectedValue={this.state.unitStart} style={[styles.inputPicker]}
								onValueChange={this.unitStart}>
						...
						{this.state.activgeschwindigkeit ? this.state.activeingabe ?
							<Picker selectedValue={this.eingabeeinheit} style={[styles.inputPicker]}
									onValueChange={this.Eingabe}>
								<Picker.Item label="Auswählen" value="null" style={styles.inputText}/>
						...
						{this.state.activstrecke ? this.state.activeingabe ?
							<Picker selectedValue={this.eingabeeinheit} style={[styles.inputPicker]}
									onValueChange={this.Eingabe}>
								<Picker.Item label="Auswählen" value="null" style={styles.inputText}/>
						...
						{this.state.activmasse ? this.state.activeingabe ?
							<Picker selectedValue={this.eingabeeinheit} style={[styles.inputPicker]}
									onValueChange={this.Eingabe}>
								<Picker.Item label="Auswählen" value="null" style={styles.inputText}/>
						...
						{this.state.activeingabe ? <TextInput onChangeText={this.Grose}
															  value={this.eingabeamount} style={styles.inputText}
															  placeholder="Bitte eingeben!"
															  placeholderTextColor="#4A4A4A"/> : null}
						{this.state.activeingabe ? <Text style={styles.inputText}>Umrechnen in:</Text> : null}
						{this.state.activgeschwindigkeit ? this.state.activeingabe ?
							<Picker selectedValue={this.eingabeumrechnen} style={[styles.inputPicker]}
									onValueChange={this.Umrechner}>
								<Picker.Item label="Auswählen" value="null" style={styles.inputText}/>
								<Picker.Item label="c" value="c" style={styles.inputText}/>
								<Picker.Item label="m/s" value="m/s" style={styles.inputText}/>
								<Picker.Item label="km/h" value="km/h" style={styles.inputText}/>
