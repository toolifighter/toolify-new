				...
				<ScrollView>
					<View style={[styles.inputContainer, {maxHeight: 350}]}>
						<Text style={styles.inputText}>Legen Sie Ihr Smartphone auf eine gerade Unterlage. Starten Sie
							die Messung und bewgen Sie das Gerät zügig zur Zielposition. Führen sie diese Messung erneut
							in entgegengesetzte Richtung durch, um Ungenauigkeiten zu vermeiden.</Text>
					</View>
					<View style={styles.outputContainer}>
						<Button onPress={this.toggle} title={this.state.buttontitle}/>
					</View>
					<View style={styles.outputContainer}>
						...
						<View style={[styles.notification, styles.outputContainer, {backgroundColor: "#ccc"}]}>
							...
							<Text
								style={styles.outputText}>Durchschnitt{this.state.ausgabedurchschnittcount}: {this.state.ausgabedurchschnitt} m</Text>
						</View>
						{this.state.fehler ?
							<View style={[styles.outputContainer, {backgroundColor: "#f00"}, styles.notification]}>
