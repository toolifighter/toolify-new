		...
		return <ScrollView>
			<View style={styles.container}>
				...
				{this.state.outputStatus ? <View>
					...
					{<View
						style={[styles.outputContainer, styles.notification, {backgroundColor: this.state.bgColorNotification}]}>
						<Text style={styles.outputText}>{this.state.notification}</Text>
						{this.state.imageStatus ?
							<Image source={require("../../images/salat.jpg")} style={styles.notificationImage}/> : null}
					</View>}
				</View> : null}
				<View style={styles.outputContainer}>
